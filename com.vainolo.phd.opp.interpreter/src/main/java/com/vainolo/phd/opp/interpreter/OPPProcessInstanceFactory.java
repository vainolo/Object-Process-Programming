...
//    OPPObjectProcessDiagram opd = OPPFileUtils.loadOPPFile(
//        OPPInterpreter.container.getFile(new Path(opdName + ".opp")).getFullPath().toString());
    OPPObjectProcessDiagram opd = OPPFileUtils.loadOPPFile(Paths.get(OPPInterpreter.workingDirectory, opdName + ".opp").toString());
