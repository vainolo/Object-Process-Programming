...
public class OPPReadTextFileProcessInstance extends OPPAbstractProcessInstance implements OPPProcessInstance {
  ...
  protected void executing() {
    ...
    String path = Paths.get(OPPInterpreter.workingDirectory, filename).toString(); //  OPPInterpreter.container.getFile(new Path(filename)).getLocation().toString(); // .getFullPath().toString();
    try {
