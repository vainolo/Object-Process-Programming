...
import static com.vainolo.phd.opp.interpreter.utils.OPMInterpreterPreconditions.*;
...
public class OPMInZoomedProcessInstanceHeap extends OPMProcessInstanceHeap {
  ...
  private final Map<OPPObject, OPMObjectInstance> variables;
   ...
   *          the value to store
   */
  public void setVariable(OPPObject object, OPMObjectInstance value) {
   ...
   */
  public OPMObjectInstance getVariable(OPPObject object) {
    if(analyzer.isObjectPartOfAnotherObject(object)) {
  ...
  private OPMObjectInstance getCollectionValueUsingReference(OPPObject source, String reference) {
  ...
  class OPMHeapChange {
    ...
    public OPMHeapChange(OPPObject object, OPMObjectInstance instance) {
      this.changeType = OPMHeapChangeType.VARIABLE_SET;
      this.object = object;
      this.objectInstance = instance;
    }

    public OPMHeapChange(OPPObject parent, OPMObjectInstance parentInstance, OPPObject child,
