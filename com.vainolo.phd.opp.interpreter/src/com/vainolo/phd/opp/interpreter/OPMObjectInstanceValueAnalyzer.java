...
public class OPMObjectInstanceValueAnalyzer {
   ...
   */
  public OPMObjectInstance calculateOPMObjectValue(OPPObject object, OPDAnalyzer analyzer) {
  ...
  /**
   * Calculate the value of an {@link OPMObjectInstance} based on a
   ...
   */
  public boolean isObjectInstanceInState(OPMObjectInstance instance, OPPState state) {
    if(instance == null) {
      return false;
    }
