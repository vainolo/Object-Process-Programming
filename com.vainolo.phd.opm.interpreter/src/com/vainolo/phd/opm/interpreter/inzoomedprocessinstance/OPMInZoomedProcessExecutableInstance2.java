 ...
 * 
 */
public class OPMInZoomedProcessExecutableInstance2 extends OPMAbstractProcessInstance implements OPMProcessInstance {
   ...
   */
  public OPMInZoomedProcessExecutableInstance2(OPMObjectProcessDiagram opd, OPDAnalyzer analyzer) {
    this.opd = opd;
