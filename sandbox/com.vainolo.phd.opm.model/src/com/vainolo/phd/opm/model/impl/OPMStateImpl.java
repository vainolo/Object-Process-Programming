 ...
 * @generated
 */
public class OPMStateImpl extends NodeImpl implements OPMState {
    /**
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == NamedElement.class) {
            switch (derivedFeatureID) {
                case OPMPackage.OPM_STATE__NAME: return OPMPackage.NAMED_ELEMENT__NAME;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == NamedElement.class) {
            switch (baseFeatureID) {
                case OPMPackage.NAMED_ELEMENT__NAME: return OPMPackage.OPM_STATE__NAME;
                default: return -1;
            }
        }
