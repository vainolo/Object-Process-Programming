...
import com.vainolo.phd.opp.editor.figure.OPPProceduralLinkSubKindLocator;

public class OPPProceduralLinkSubKindLocatorTest {
  OPPProceduralLinkSubKindLocator locator;
  ...
  private void performTest(int sourceX, int sourceY, int targetX, int targetY, int xOffset, int yOffset, int expectedX,
    ...
    locator = new OPPProceduralLinkSubKindLocator(mock(Connection.class), xOffset, yOffset);
