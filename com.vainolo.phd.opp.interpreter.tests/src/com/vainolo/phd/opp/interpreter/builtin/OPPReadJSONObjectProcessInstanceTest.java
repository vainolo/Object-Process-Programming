...
public class OPPReadJSONObjectProcessInstanceTest {
  ...
  public void test_execute_stringElement() throws Exception {
    OPPComplexObjectInstance instance = (OPPComplexObjectInstance) readJson("{\"a\":\"hello\"}");
    assertEquals("hello", instance.getPart("a").getStringValue());
  }

  @Test
  public void test_execute_booleanElement() throws Exception {
    OPPComplexObjectInstance instance = (OPPComplexObjectInstance) readJson("{\"a\":false}");
    assertEquals("false", instance.getPart("a").getStringValue());
  }

  @Test
  public void text_execute_multipleElements() throws Exception {
    OPPComplexObjectInstance instance = (OPPComplexObjectInstance) readJson("{\"a\":false,\"b\":2}");
    assertEquals("false", instance.getPart("a").getStringValue());
  ...
  public void test_execute_complexInstance() throws Exception {
    ...
    assertEquals("true", ((OPPComplexObjectInstance) instance.getPart("a")).getPart("b").getStringValue());
    assertEquals(3, ((OPPComplexObjectInstance) instance.getPart("a")).getPart("c").getNumericalValue().intValue());
    assertEquals("hello", ((OPPComplexObjectInstance) instance.getPart("a")).getPart("d").getStringValue());
  }
}