...
public class OPMNodeGraphicalNodeEditPolicy extends GraphicalNodeEditPolicy {
     ...
     * <ol>
     *   <li>If this is the first structural link of its kind between the source and target
     * nodes, we create a new aggregator and connect it to the source and target.</li>
     *   <li>If there already is an aggregator of its kind between the nodes, we only
     * add a new link from the aggregator to the new target.</li>
     * </ol>     
    ...
    /**
     * Create a command that adds the provided {@link OPMStructuralLinkAggregator} to the diagram
     * located between the source and the target {@link OPMNode}.
     * @param source the source for the structural link.
     * @param target the target of the structural link.
     * @param aggregator the aggregator that should be added to the diagram.
