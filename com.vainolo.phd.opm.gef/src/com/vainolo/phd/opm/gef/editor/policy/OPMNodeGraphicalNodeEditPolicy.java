...
public class OPMNodeGraphicalNodeEditPolicy extends GraphicalNodeEditPolicy {
  ...
  protected Command getConnectionCreateCommand(CreateConnectionRequest request) {
    ...
    result.setOPD(OPDUtils.getOPD((OPMNode) getHost().getModel()));
  ...
  private Command handleOPMStructuralLinkRequest(CreateConnectionRequest request) {
    ...
    for(OPMLink structuralLink : OPDUtils.getOutgoingStructuralLinks(sNode)) {
    ...
    if(aggregatorFound) {
      ...
      command = createCreateOPMLlinkCreateCommand(agrNode, tNode, OPDUtils.getOPD(agrNode));
    } else {
      ...
      cCommand.add(createCreateOPMLlinkCreateCommand(sNode, agrNode, OPDUtils.getOPD(sNode)));
      cCommand.add(createCreateOPMLlinkCreateCommand(agrNode, tNode, OPDUtils.getOPD(sNode)));
