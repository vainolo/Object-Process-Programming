 ...
 *******************************************************************************/
package com.vainolo.phd.opm.gef.editor.part.delegates;
...
public class DirectEditDelegate {
  public static void performDirectEditing(GraphicalEditPart editPart, SmartLabelFigure textFigure) {
    ...
    manager =
        new OPMNamedElementDirectEditManager(editPart, TextCellEditor.class, new OPMNamedElementCellEditorLocator(
