...
public class OPMGraphicalEditorPalette extends PaletteRoot {
	...
	private PaletteEntry createBasicOPMPaletteTools() {
		...
		drawer.add(new CreationToolEntry("Label", "Create new Label",
				new LabelFactory(), ImageDescriptor.createFromFile(
						this.getClass(), "icons/label.ico"), ImageDescriptor
						.createFromFile(this.getClass(), "icons/label.ico")));

		ToolEntry entry = new CombinedTemplateCreationEntry("OPMObject",
				"Create a new Object", new OPMObjectFactory(),
				ImageDescriptor.createFromFile(this.getClass(),
						"icons/object.ico"), ImageDescriptor.createFromFile(
						this.getClass(), "icons/object.ico"));
		entry.setToolClass(CreationAndDirectEditTool.class);
		drawer.add(entry);

		entry = new CreationToolEntry("OPMProcess", "Create a new Process",
				new OPMProcessFactory(), ImageDescriptor.createFromFile(
		...
		entry = new CreationToolEntry("OPMState", "Create a new State",
				new OPMStateFactory(), ImageDescriptor.createFromFile(
		...
		drawer.add(new ConnectionCreationToolEntry("Instrument",
				"Create a new Instrument link", new OPMInstrumentLinkFactory(),
				ImageDescriptor.createFromFile(this.getClass(),
						"icons/instrument.ico"),
				ImageDescriptor.createFromFile(this.getClass(),
						"icons/instrument.ico")));

		drawer.add(new ConnectionCreationToolEntry("Result",
				"Create a new Result link", new OPMResultLinkFactory(),
				ImageDescriptor.createFromFile(this.getClass(),
						"icons/result.ico"), ImageDescriptor.createFromFile(
						this.getClass(), "icons/result.ico")));

		drawer.add(new ConnectionCreationToolEntry("Consumption",
				"Create a new Consumption link",
				new OPMConsumptionLinkFactory(), ImageDescriptor
						.createFromFile(this.getClass(),
								"icons/consumption.ico"), ImageDescriptor
						.createFromFile(this.getClass(),
								"icons/consumption.ico")));

		drawer.add(new ConnectionCreationToolEntry("Aggregation",
				"Create a new Aggregation link",
				new OPMAggregationStructuralLinkAggregatorFactory(),
				ImageDescriptor.createFromFile(this.getClass(),
						"icons/aggregation.ico"), ImageDescriptor
						.createFromFile(this.getClass(),
								"icons/aggregation.ico")));
		drawer.add(new ConnectionCreationToolEntry("Exhibition",
				...
				ImageDescriptor.createFromFile(this.getClass(),
						"icons/exhibition.ico")));
		drawer.add(new ConnectionCreationToolEntry("Generalization",
				"Create a new Generalization link",
				new OPMGeneralizationStructuralLinkAggregatorFactory(),
				ImageDescriptor.createFromFile(this.getClass(),
						"icons/generalization.ico"), ImageDescriptor
						.createFromFile(this.getClass(),
	...
	private void addOPMProceduralLinkTools() {
		...
		entry = new ConnectionCreationToolEntry("Agent",
				"Create a new Agent link", new OPMAgentLinkFactory(),
				ImageDescriptor.createFromFile(this.getClass(),
						"icons/agent.ico"), ImageDescriptor.createFromFile(
		...
		entry = new ConnectionCreationToolEntry("Effect",
				"Create a new Effect link", new OPMEffectLinkFactory(),
				ImageDescriptor.createFromFile(this.getClass(),
						"icons/effect.ico"), ImageDescriptor.createFromFile(
						this.getClass(), "icons/effect.ico"));
		group.add(entry);

		entry = new ConnectionCreationToolEntry("Invocation",
				"Create a new Invocation link", new OPMInvocationLinkFactory(),
				ImageDescriptor.createFromFile(this.getClass(),
						"icons/invocation.ico"),
				ImageDescriptor.createFromFile(this.getClass(),
						"icons/invocation.ico"));
		group.add(entry);
