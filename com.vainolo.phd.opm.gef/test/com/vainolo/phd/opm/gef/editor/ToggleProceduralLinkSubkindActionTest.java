...
public class ToggleProceduralLinkSubkindActionTest extends ToggleProceduralLinkSubkindAction {
  ...
  public void test_Constructor_ToggleConditional() {
    ...
    assertEquals(ToggleProceduralLinkSubkindActionTest.CONDITIONAL_SUBKIND_ID,
        request.getExtendedData().get("id"));
  }
  ...
  public void test_Constructor_ToggleEvent() {
    ToggleProceduralLinkSubkindAction action = new ToggleProceduralLinkSubkindAction(mock(IWorkbenchPart.class),
        EVENT_SUBKIND_ID);
    Request request = action.getRequest();
    assertEquals(ToggleProceduralLinkSubkindActionTest.EVENT_SUBKIND_ID, request.getExtendedData().get("id"));
  }
  ...
  public void test_Constructor_ToggleOptional() {
    ToggleProceduralLinkSubkindAction action = new ToggleProceduralLinkSubkindAction(mock(IWorkbenchPart.class),
        OPTIONAL_SUBKIND_ID);
    Request request = action.getRequest();
    assertEquals(ToggleProceduralLinkSubkindActionTest.OPTIONAL_SUBKIND_ID, request.getExtendedData().get("id"));
  }
