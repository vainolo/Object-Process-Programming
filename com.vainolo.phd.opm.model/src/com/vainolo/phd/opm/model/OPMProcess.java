...
public interface OPMProcess extends OPMThing {
  ...
  /**
   * Returns the value of the '<em><b>Kind</b></em>' attribute. The default value is <code>""</code>. The literals are
   * from the enumeration {@link com.vainolo.phd.opm.model.OPMProcessKind}. <!-- begin-user-doc -->
   * <p>
