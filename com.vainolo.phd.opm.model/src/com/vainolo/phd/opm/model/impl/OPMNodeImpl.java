...
public abstract class OPMNodeImpl extends EObjectImpl implements OPMNode {
	/**
	 * The cached value of the '{@link #getIncomingLinks() <em>Incoming Links</em>}' reference list. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getOutgoingLinks() <em>Outgoing Links</em>}' reference list. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 ...
	 * @generated
	 */
	public NotificationChain basicSetContainer(final OPMContainer newContainer, NotificationChain msgs) {
	 ...
	 */
	@Override
	public void setContainer(final OPMContainer newContainer) {
	 ...
	 */
	@Override
	public void setConstraints(final Rectangle newConstraints) {
		final Rectangle oldConstraints = constraints;
	...
	/**
	 * <!-- begin-user-doc --> Return a list of incoming links that start at a {@link OPMStructuralLinkAggregator} and
	 * end at this node. The current implementation calculates this list by calling
	 * {@link OPMNodeImpl#getIncomingLinks()} and filtering the results. <!-- end-user-doc -->
	 * 
	 * @generated NOT
	 */
	@Override
	...
	/**
	 * <!-- begin-user-doc --> Finds the container {@link OPMObjectProcessDiagram} by going up in the
	 * {@link OPMContainer} hierarchy until it is found.
	 * 
	 * @return the containing {@link OPMObjectProcessDiagram}, which is the topmost {@link OPMContainer} in the
	 *         container hierarchy. <!-- end-user-doc -->
	 * @generated NOT
	 */
	@Override
	...
	public EList<OPMLink> getIncomingProceduralLinks() {
		final EList<OPMLink> incomingProceduralLinks = new BasicEList<OPMLink>();
		for(final OPMLink link : getIncomingLinks())
	...
	public EList<OPMLink> getOutgoingProceduralLinks() {
		final EList<OPMLink> outgoingProceduralLinks = new BasicEList<OPMLink>();
		for(final OPMLink link : getOutgoingLinks())
			if(link instanceof OPMProceduralLink)
