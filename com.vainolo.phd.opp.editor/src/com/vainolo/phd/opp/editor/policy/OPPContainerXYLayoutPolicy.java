...
public class OPPContainerXYLayoutPolicy extends XYLayoutEditPolicy {
   ...
   * {@link OPPContainerXYLayoutPolicy#getResizeChildrenCommand(ChangeBoundsRequest) getResizeChildrenCommand()} by
   * default. This is not good in our case since we want to disallow resizing of
