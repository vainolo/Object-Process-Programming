...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tagged Link View</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.vainolo.opm.model.opm.impl.OPTaggedLinkViewImpl#getSystem <em>System</em>}</li>
 *   <li>{@link com.vainolo.opm.model.opm.impl.OPTaggedLinkViewImpl#getOpd <em>Opd</em>}</li>
 *   <li>{@link com.vainolo.opm.model.opm.impl.OPTaggedLinkViewImpl#getModel <em>Model</em>}</li>
 *   <li>{@link com.vainolo.opm.model.opm.impl.OPTaggedLinkViewImpl#getSource <em>Source</em>}</li>
 *   <li>{@link com.vainolo.opm.model.opm.impl.OPTaggedLinkViewImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OPTaggedLinkViewImpl extends MinimalEObjectImpl.Container implements OPTaggedLinkView {
	/**
	 ...
	 * @generated
	 */
	protected OPTaggedLinkViewImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OPPackage.Literals.OP_TAGGED_LINK_VIEW;
	}
	...
	public OPSystem getSystem() {
		if (eContainerFeatureID() != OPPackage.OP_TAGGED_LINK_VIEW__SYSTEM) return null;
	...
	public NotificationChain basicSetSystem(OPSystem newSystem, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSystem, OPPackage.OP_TAGGED_LINK_VIEW__SYSTEM, msgs);
		return msgs;
	}
	...
	public void setSystem(OPSystem newSystem) {
		if (newSystem != eInternalContainer() || (eContainerFeatureID() != OPPackage.OP_TAGGED_LINK_VIEW__SYSTEM && newSystem != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OPPackage.OP_TAGGED_LINK_VIEW__SYSTEM, newSystem, newSystem));
	}
	...
	public OPObjectProcessDiagram getOpd() {
		if (eContainerFeatureID() != OPPackage.OP_TAGGED_LINK_VIEW__OPD) return null;
	...
	public NotificationChain basicSetOpd(OPObjectProcessDiagram newOpd, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOpd, OPPackage.OP_TAGGED_LINK_VIEW__OPD, msgs);
		return msgs;
	}
	...
	public void setOpd(OPObjectProcessDiagram newOpd) {
		if (newOpd != eInternalContainer() || (eContainerFeatureID() != OPPackage.OP_TAGGED_LINK_VIEW__OPD && newOpd != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OPPackage.OP_TAGGED_LINK_VIEW__OPD, newOpd, newOpd));
	}
		...
		if (model != null && model.eIsProxy()) {
			...
			if (model != oldModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OPPackage.OP_TAGGED_LINK_VIEW__MODEL, oldModel, model));
			}
		}
		return model;
	}
	...
	public void setModel(OPElement newModel) {
		...
		model = newModel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OPPackage.OP_TAGGED_LINK_VIEW__MODEL, oldModel, model));
	}
	...
	public OPNodeView getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OPPackage.OP_TAGGED_LINK_VIEW__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public NotificationChain basicSetSource(OPNodeView newSource, NotificationChain msgs) {
		...
		source = newSource;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OPPackage.OP_TAGGED_LINK_VIEW__SOURCE, oldSource, newSource);
	...
	public void setSource(OPNodeView newSource) {
		if (newSource != source) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OPPackage.OP_TAGGED_LINK_VIEW__SOURCE, newSource, newSource));
	}
	...
	public OPNodeView getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OPPackage.OP_TAGGED_LINK_VIEW__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public NotificationChain basicSetTarget(OPNodeView newTarget, NotificationChain msgs) {
		...
		target = newTarget;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OPPackage.OP_TAGGED_LINK_VIEW__TARGET, oldTarget, newTarget);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTarget(OPNodeView newTarget) {
		if (newTarget != target) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OPPackage.OP_TAGGED_LINK_VIEW__TARGET, newTarget, newTarget));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OPPackage.OP_TAGGED_LINK_VIEW__SYSTEM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetSystem((OPSystem)otherEnd, msgs);
			case OPPackage.OP_TAGGED_LINK_VIEW__OPD:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetOpd((OPObjectProcessDiagram)otherEnd, msgs);
			case OPPackage.OP_TAGGED_LINK_VIEW__SOURCE:
				if (source != null)
					msgs = ((InternalEObject)source).eInverseRemove(this, OPPackage.OP_NODE_VIEW__OUTGOING_LINKS, OPNodeView.class, msgs);
				return basicSetSource((OPNodeView)otherEnd, msgs);
			case OPPackage.OP_TAGGED_LINK_VIEW__TARGET:
				if (target != null)
					msgs = ((InternalEObject)target).eInverseRemove(this, OPPackage.OP_NODE_VIEW__INCOMING_LINKS, OPNodeView.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OPPackage.OP_TAGGED_LINK_VIEW__OPD:
				return getOpd();
			case OPPackage.OP_TAGGED_LINK_VIEW__MODEL:
