...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tagged Link</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.vainolo.opm.model.opm.impl.OPTaggedLinkImpl#getSystem <em>System</em>}</li>
 *   <li>{@link com.vainolo.opm.model.opm.impl.OPTaggedLinkImpl#getSource <em>Source</em>}</li>
 *   <li>{@link com.vainolo.opm.model.opm.impl.OPTaggedLinkImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OPTaggedLinkImpl extends MinimalEObjectImpl.Container implements OPTaggedLink {
	/**
	...
	protected EClass eStaticClass() {
		return OPPackage.Literals.OP_TAGGED_LINK;
	}
	...
	public OPSystem getSystem() {
		if (eContainerFeatureID() != OPPackage.OP_TAGGED_LINK__SYSTEM) return null;
	...
	public NotificationChain basicSetSystem(OPSystem newSystem, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSystem, OPPackage.OP_TAGGED_LINK__SYSTEM, msgs);
		return msgs;
	}
	...
	public void setSystem(OPSystem newSystem) {
		if (newSystem != eInternalContainer() || (eContainerFeatureID() != OPPackage.OP_TAGGED_LINK__SYSTEM && newSystem != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OPPackage.OP_TAGGED_LINK__SYSTEM, newSystem, newSystem));
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OPPackage.OP_TAGGED_LINK__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public NotificationChain basicSetSource(OPNode newSource, NotificationChain msgs) {
		...
		source = newSource;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OPPackage.OP_TAGGED_LINK__SOURCE, oldSource, newSource);
	...
	public void setSource(OPNode newSource) {
		if (newSource != source) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OPPackage.OP_TAGGED_LINK__SOURCE, newSource, newSource));
	}
	...
	public OPNode getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OPPackage.OP_TAGGED_LINK__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public NotificationChain basicSetTarget(OPNode newTarget, NotificationChain msgs) {
		...
		target = newTarget;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OPPackage.OP_TAGGED_LINK__TARGET, oldTarget, newTarget);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTarget(OPNode newTarget) {
		if (newTarget != target) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OPPackage.OP_TAGGED_LINK__TARGET, newTarget, newTarget));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OPPackage.OP_TAGGED_LINK__SYSTEM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetSystem((OPSystem)otherEnd, msgs);
			case OPPackage.OP_TAGGED_LINK__SOURCE:
				if (source != null)
					msgs = ((InternalEObject)source).eInverseRemove(this, OPPackage.OP_NODE__OUTGOING_LINKS, OPNode.class, msgs);
				return basicSetSource((OPNode)otherEnd, msgs);
			case OPPackage.OP_TAGGED_LINK__TARGET:
				if (target != null)
					msgs = ((InternalEObject)target).eInverseRemove(this, OPPackage.OP_NODE__INCOMING_LINKS, OPNode.class, msgs);
