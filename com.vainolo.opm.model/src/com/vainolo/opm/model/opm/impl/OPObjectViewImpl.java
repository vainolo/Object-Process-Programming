 ...
 * <ul>
 *   <li>{@link com.vainolo.opm.model.opm.impl.OPObjectViewImpl#getSystem <em>System</em>}</li>
 ...
 *   <li>{@link com.vainolo.opm.model.opm.impl.OPObjectViewImpl#getIncomingLinks <em>Incoming Links</em>}</li>
 *   <li>{@link com.vainolo.opm.model.opm.impl.OPObjectViewImpl#getOutgoingLinks <em>Outgoing Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OPObjectViewImpl extends MinimalEObjectImpl.Container implements OPObjectView {
	...
	public OPSystem getSystem() {
		if (eContainerFeatureID() != OPPackage.OP_OBJECT_VIEW__SYSTEM) return null;
	...
	public NotificationChain basicSetSystem(OPSystem newSystem, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSystem, OPPackage.OP_OBJECT_VIEW__SYSTEM, msgs);
		return msgs;
	}
	...
	public void setSystem(OPSystem newSystem) {
		if (newSystem != eInternalContainer() || (eContainerFeatureID() != OPPackage.OP_OBJECT_VIEW__SYSTEM && newSystem != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OPPackage.OP_OBJECT_VIEW__SYSTEM, newSystem, newSystem));
	}
	...
	public EList<OPLinkView> getIncomingLinks() {
		if (incomingLinks == null) {
			incomingLinks = new EObjectWithInverseResolvingEList<OPLinkView>(OPLinkView.class, this, OPPackage.OP_OBJECT_VIEW__INCOMING_LINKS, OPPackage.OP_LINK_VIEW__TARGET);
		}
	...
	public EList<OPLinkView> getOutgoingLinks() {
		if (outgoingLinks == null) {
			outgoingLinks = new EObjectWithInverseResolvingEList<OPLinkView>(OPLinkView.class, this, OPPackage.OP_OBJECT_VIEW__OUTGOING_LINKS, OPPackage.OP_LINK_VIEW__SOURCE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OPPackage.OP_OBJECT_VIEW__SYSTEM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
			...
			case OPPackage.OP_OBJECT_VIEW__INCOMING_LINKS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIncomingLinks()).basicAdd(otherEnd, msgs);
			case OPPackage.OP_OBJECT_VIEW__OUTGOING_LINKS:
