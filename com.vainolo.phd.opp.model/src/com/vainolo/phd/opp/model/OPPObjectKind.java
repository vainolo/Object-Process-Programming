 ...
 * <!-- end-user-doc -->
 * @see com.vainolo.phd.opp.model.OPPPackage#getOPPObjectKind()
 * @model
 * @generated
 */
public enum OPPObjectKind implements Enumerator {
  /**
   ...
   * @generated
   */
  private static final OPPObjectKind[] VALUES_ARRAY =
    new OPPObjectKind[] {
      SIMPLE,
      COLLECTION,
    };
   ...
   * @generated
   */
  public static final List<OPPObjectKind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
   ...
   * @generated
   */
  public static OPPObjectKind get(String literal) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      OPPObjectKind result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static OPPObjectKind getByName(String name) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      OPPObjectKind result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static OPPObjectKind get(int value) {
    switch (value) {
   ...
   * @generated
   */
  private OPPObjectKind(int value, String name, String literal) {
    this.value = value;
    this.name = name;
