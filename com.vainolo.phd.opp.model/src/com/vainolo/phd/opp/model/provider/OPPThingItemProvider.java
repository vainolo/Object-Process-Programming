...
/**
 * This is the item provider adapter for a {@link com.vainolo.phd.opp.model.OPPThing} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OPPThingItemProvider extends OPPNodeItemProvider {
  /**
   ...
   * @generated
   */
  public OPPThingItemProvider(AdapterFactory adapterFactory) {
  ...
  protected void addDescriptionPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_OPPThing_description_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_OPPThing_description_feature", "_UI_OPPThing_type"),
         OPPPackage.Literals.OPP_THING__DESCRIPTION,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public String getText(Object object) {
    String label = ((OPPThing)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_OPPThing_type") :
      getString("_UI_OPPThing_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(OPPThing.class)) {
