...
/**
 * This is the item provider adapter for a {@link com.vainolo.phd.opp.model.OPPNamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OPPNamedElementItemProvider 
   ...
   * @generated
   */
  public OPPNamedElementItemProvider(AdapterFactory adapterFactory) {
  ...
  public String getText(Object object) {
    String label = ((OPPNamedElement)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_OPPNamedElement_type") :
      getString("_UI_OPPNamedElement_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(OPPNamedElement.class)) {
