...
/**
 * This is the item provider adapter for a {@link com.vainolo.phd.opp.model.OPPState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OPPStateItemProvider extends OPPNodeItemProvider {
  /**
   ...
   * @generated
   */
  public OPPStateItemProvider(AdapterFactory adapterFactory) {
  ...
  protected void addValuePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_OPPState_value_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_OPPState_value_feature", "_UI_OPPState_type"),
         OPPPackage.Literals.OPP_STATE__VALUE,
         true,
         false,
         false,
  ...
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/OPPState"));
  }
  ...
  public String getText(Object object) {
    String label = ((OPPState)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_OPPState_type") :
      getString("_UI_OPPState_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(OPPState.class)) {
