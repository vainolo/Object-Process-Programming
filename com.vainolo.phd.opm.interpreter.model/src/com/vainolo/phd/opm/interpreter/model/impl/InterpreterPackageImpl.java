...
public class InterpreterPackageImpl extends EPackageImpl implements InterpreterPackage {
	 ...
	 * @see com.vainolo.phd.opm.interpreter.model.InterpreterPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link InterpreterPackage#eINSTANCE} when that field is accessed. Clients
	...
	public static InterpreterPackage init() {
		...
		final InterpreterPackageImpl theInterpreterPackage = (InterpreterPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof InterpreterPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
